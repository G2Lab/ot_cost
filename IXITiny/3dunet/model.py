...
from buildingblocks import Encoder, Decoder, SingleConv, DoubleConv, ResNetBlock, ResNetBlockSE, \
...
class UNet2D(AbstractUNet):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=True, f_maps=64, layer_order='sscr',
                 num_groups=8, num_levels=4, is_segmentation=True, conv_padding=1, **kwargs):
